...
var CPXQuery = (function (_super) {
    __extends(CPXQuery, _super);
    function CPXQuery() {
    ...
    Object.defineProperty(CPXQuery.prototype, "auto", {
        get: function () {
            return this._auto;
        },
        set: function (val) {
    ...
    Object.defineProperty(CPXQuery.prototype, "filters", {
        get: function () {
    ...
    Object.defineProperty(CPXQuery.prototype, "activeFilters", {
        get: function () {
    ...
    Object.defineProperty(CPXQuery.prototype, "from", {
        get: function () {
            return this._from;
        },
        set: function (val) {
    ...
    Object.defineProperty(CPXQuery.prototype, "limit", {
        get: function () {
            return this._limit;
        },
        set: function (val) {
    ...
    Object.defineProperty(CPXQuery.prototype, "sort", {
        get: function () {
            return this._sort;
        },
        set: function (val) {
    ...
    Object.defineProperty(CPXQuery.prototype, "results", {
        get: function () {
    ...
    Object.defineProperty(CPXQuery.prototype, "term", {
        get: function () {
            return this._term;
        },
        set: function (val) {
    ...
    Object.defineProperty(CPXQuery.prototype, "url", {
        get: function () {
            return this._url;
        },
        set: function (val) {
    ...
    Object.defineProperty(CPXQuery.prototype, "valid", {
        get: function () {
            return this._valid;
        },
        set: function (val) {
    ...
    CPXQuery.prototype.filterString = function (facets) {
    ...
    CPXQuery.prototype.connectedCallback = function () {
    ...
    Object.defineProperty(CPXQuery, "observedAttributes", {
        get: function () {
    ...
    CPXQuery.prototype.attributeChangedCallback = function (name, oldVal, newVal) {
        this[name] = newVal;
    };
    CPXQuery.prototype._setFilters = function (item) {
        var add = item.active;
        if (add) {
    ...
    CPXQuery.prototype._changeAttr = function (e) {
        switch (e.type) {
            case 'term-change':
    ...
    CPXQuery.prototype.search = function () {
        var _this = this;

...
link:https://developers.redhat.com/articles/2022/07/15/new-http-clients-java-generator-and-more-fabric8-600[New HTTP clients, a Java generator, and more in Fabric8 6.0.0] by Andrea Peruffo and Steven Havwkins
...
* link:https://[Kube by Example #13 with Travis Nielsen]
